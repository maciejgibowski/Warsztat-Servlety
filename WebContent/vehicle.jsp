...
<p>Wybierz akcję:</p>
<p><a href="<c:url value="/vehicle_form_add.jsp"/>">Dodaj samochód</a></p>
<p><a href="<c:url value="/vehicle_form_edit_1.jsp"/>">Edytuj samochód</a></p>
<p><a href="<c:url value="/vehicle_form_remove.jsp"/>">Usuń samochód</a></p>
