...
<%
Commission commission = (Commission) session.getAttribute("commission");
...
<p>Wybierz akcję:</p>
<p><a href="<c:url value="/Commission_PreEdit?id=${commission.getId()}"/>">Edytuj zlecenie</a></p>
<p><a href="<c:url value="/Commission_Remove?id=${commission.getId()}"/>">Usuń zlecenie</a></p>
